	...
	function admin_page_handler() {
		...
		<div class="wrap">
			<div class="postbox cpm-pro-notice">
				...
				<a target="_blank" href="https://mtaandao.co.ke/plugins/project-manager?utm_source=freeplugin&utm_medium=prompt&utm_term=cpm_free_plugin&utm_content=textlink&utm_campaign=pro_prompt" class="button button-primary"><?php _e( 'Upgrade to Pro Version', 'cpm' ); ?></a>
			</div>
		</div>
		<?php
	}
