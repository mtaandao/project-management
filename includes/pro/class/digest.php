...
class CPM_Pro_Digest {
    ...
    function table_close() {
        ...
        $plug_link = sprintf( '<a href="%s" style="color: #1993c4;text-decoration: none;">%s</a>', 'https://mtaandao.co.ke/plugins/project-manager?utm_source=cpm_digest&utm_medium=email&utm_campaign=cpm', 'WP Project Manager' );
        ?>
            </table>
        </div>
